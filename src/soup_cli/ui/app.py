"""FastAPI application for the Khadhi Web UI."""
...
def create_app(host: str = "127.0.0.1", port: int = 7860):
    ...
    def system_info():
        ...
        pytorch_cuda_available = device == "cuda"
        if not pytorch_cuda_available and gpu_info.get("gpu_names"):
            device_name = (
                f"{gpu_info['gpu_names'][0]} "
